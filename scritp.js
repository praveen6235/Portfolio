...
const projectScroll = document.getElementById("projects-scroll");
const projectLeft = document.getElementById("project-scroll-left");
const projectRight = document.getElementById("project-scroll-right");
